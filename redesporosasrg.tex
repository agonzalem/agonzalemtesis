\chapter[Construcción Secuencial]{Construcción Secuencial de Redes Porosas respetando $RG$}
\label{champ:BSGR}
\bigskip
\barra
\bigskip
...
\section{Solución Básica Aleatoria basada en el Método de Monte Carlo: Inicializaci\'on}
\label{sec:smcrg}
